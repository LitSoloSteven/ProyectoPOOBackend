...
In ProyectoBackend-labels_en.properties:
ProyectoBackend=My application
ProyectoBackend[description]=My application does this and that

In ProyectoBackend-messages_en.properties:
